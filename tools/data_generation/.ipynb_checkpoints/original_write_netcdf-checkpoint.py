...
def write_3D_grid(file, var, lon, lat, lev, varname=None):
    ...
    if isinstance(var,dict):
        ...
        for varname in var.keys():
            ...
            ext[varname] = outdataset.createVariable(varname,np.float64, ('lev','lat','lon'))
    ...
    # if only one variable is saved
        ...
        ext    = outdataset.createVariable(varname,np.float64, ('lev','lat','lon'))
