# Made by Atte Laakso / UEF
import pandas as pd

"""
refractive indices of chemical compounds for different models
"""
...
def import_refrac(name):
    ...
    file_path='/scratch/project_2010692/tools/data_generation/ref_ind_storage.csv'
