...
#SBATCH --cpus-per-task=12                       # Number of CPU cores per job
#SBATCH --mem-per-cpu=6G                        # Memory reserved for one core
#SBATCH --mail-type=ALL                          # Send email at job completion
#SBATCH --mail-user=attelaak@uef.fi              # Email address for notifications
...
cd /scratch/project_2010692/tools/data_generation_CDNC
