...
outPath = '/scratch/project_2010692/tools/output_CDNC'
...
def main(month_sel,months):
    ...
    if months:
        ...
        for month in months:
            for m2 in models:
                arg_list.append((model1,m2,time[month-1],light,mmrsel,nmrsel,updraftsel,cltsel,clwsel,avoid_print_on,calculate_CRE,[outPath,SALSAPath,temp,AeroCom]))
        # update logging
